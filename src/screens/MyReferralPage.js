...
const selectEndYear = (year) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.dropdownButton} onPress={() => setIsStartYearModalVisible(true)}>
                <Text styles={styles.dropdownButtonText}> Select Start Year: {startYear} </Text>
            ...
            {/* Modal for end year */}
            <TouchableOpacity style={styles.dropdownButton} onPress={() => setIsEndYearModalVisible(true)}>
                <Text styles={styles.dropdownButtonText}> Select End Year: {endYear} </Text>
                <Icon name="arrow-drop-down" size={20} color="black"/>
            </TouchableOpacity>
